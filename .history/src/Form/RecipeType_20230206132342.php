...
class RecipeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('description', TextareaType::class, [
            ...
            'constraints' => [
                new Assert\NotBlank([
                    'message' => 'Veuillez saisir une description de la recette'
                ]),
                new Assert\Length([
                    'min' => 2,
                    'minMessage' => 'La description de la recette doit faire au moins {{ limit }} caractères',
                    'max' => 500,
                    'maxMessage' => 'La description de la recette doit faire au plus {{ limit }} caractères'
                ])
            ]
        ])
